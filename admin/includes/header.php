...
<head>
    ...
    <title>Rubkhar Admin Panel</title>
    ...
    <style>
        ...
        .form-label { display: block; margin-bottom: 5px; font-weight: 500; color: #444; }
        ...
        .badge-shipped { background: #e67e22; }
...
<aside class="sidebar">
    <div class="sidebar-brand">Rubkhar</div>
    <ul class="sidebar-menu">
        ...
        <li><a href="coupons.php" class="<?= $current_page == 'coupons.php' ? 'active' : '' ?>"><i class="fas fa-ticket-alt"></i> Coupons</a></li>
        <li><a href="categories.php" class="<?= $current_page == 'categories.php' ? 'active' : '' ?>"><i class="fas fa-tags"></i> Categories</a></li>
    </ul>
...
<div class="main-content">
    <header class="topbar">
        <h2 class="page-title"><?= ucfirst(str_replace('.php', '', $current_page == 'index.php' ? 'Dashboard' : $current_page)) ?></h2>
        <div class="topbar-user">
            <span>Welcome, <?= htmlspecialchars($_SESSION['admin_name'] ?? 'Admin') ?></span>
            <a href="../index.php" target="_blank" class="btn btn-gold btn-sm"><i class="fas fa-store"></i> View Store</a>
        </div>
    </header>
